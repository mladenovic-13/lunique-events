      ...
      <div className="space-y-3">
        ...
        <div className="flex w-4/5 justify-between">
          <div className="flex flex-col">
            <p className="text-sm text-accent-foreground/50">Yesterday</p>
            <p className="text-2xl font-semibold">0</p>
          </div>
          <div className="flex flex-col">
            <p className="text-sm text-accent-foreground/50">Past Month</p>
      ...
      <div className="space-y-3">
        ...
        <div className="flex w-[90%] flex-col justify-between space-y-2">
          <div className="flex justify-between">
            ...
            <div>
              <p className="text-sm text-accent-foreground/50">50%</p>
            </div>
          </div>
          <div className="flex justify-between">
            <div>
              <p className="text-sm text-accent-foreground/50">Direct</p>
            </div>
            <div>
              <p className="text-sm text-accent-foreground/50">50%</p>
            </div>
        ...
        <h1 className="text-lg font-semibold capitalize">Top Cities</h1>
        <div className="flex w-[90%] flex-col justify-between space-y-2">
          <div className="flex justify-between">
            <div>
              <p className="text-sm text-accent-foreground/50">
        ...
        <h1 className="text-lg font-semibold capitalize">Top Sources</h1>
